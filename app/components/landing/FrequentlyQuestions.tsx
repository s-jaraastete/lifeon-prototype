...
const DEFAULT_DESCRIPTION =
  "Encuentra respuestas sobre LifeOn, su implementación y la forma en que puede adaptarse a las necesidades de tu empresa.";

const FrequentlyQuestions = ({ items, title, description }: FrequentlyQuestion) => {
  const showDescription = title === undefined || description !== undefined;
