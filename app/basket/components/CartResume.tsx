    ...
    <div className="w-full  bg-white">
      <div>
        <div className="border-b border-gray-400 w-full">
          <div className="py-5 flex items-center max-w-360 mx-auto">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <div className="border border-gray-400 rounded-2xl bg-white p-6">
                    ...
                    <button className="mt-6 w-full bg-gray-200 text-gray-400 py-3 rounded-lg" disabled>
                      Ir a pagar
                      <LuChevronRight className="w-4 h-4 inline-block ml-2" />
                    </button>

                    <div className="mt-4 flex items-center justify-end gap-2">
                      <Image src="/images/pay_methods.png" alt="Payment Method" width={134} height={100} />
                    </div>
                  </div>
                </div>
              </div>
