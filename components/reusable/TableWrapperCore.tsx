          ...
          <tr>
            {props.headers.map((header, idx) => 
              <th
                ...
                className={clsx(
                'h-[50px] border-b border-gray-300 px-5 py-2.5 text-left text-body-sm font-medium leading-[22px] text-gray-950',
        ...
        <tbody>
          {(props.isLoading || props.data === undefined) ? (
            ...
            props.data.map((item, index) => (
              <Fragment key={index}>
                <tr className='border-b border-gray-300 align-middle last:border-none hover:bg-gray-100 [&>td]:min-h-[50px] [&>td]:px-5 [&>td]:py-2.5 [&>td]:text-body-sm [&>td]:leading-[22px] [&>td]:text-gray-800'>
